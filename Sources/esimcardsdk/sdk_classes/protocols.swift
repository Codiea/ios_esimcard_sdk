...
internal protocol PurchaseBundlesProtocol {
    ...
    func fetchPackagesByCountry(newApiUrl:String, token: String, page: String, countryID: String, completion: @escaping (PackagesByCountryResponseModel?, Error?) -> Void)
    
    func fetchContinent(newApiUrl:String, token: String, completion: @escaping (ContinentsResponseModel?, Error?) -> Void)

    func fetchPackagesByContinent(newApiUrl:String, token: String, page: String, continentID: String, completion: @escaping (PackagesByContinentResponseModel?, Error?) -> Void)

    func fetchGlobalPackages(newApiUrl:String, token: String, page: String, completion: @escaping (GlobalPackagesResponseModel?, Error?) -> Void)
